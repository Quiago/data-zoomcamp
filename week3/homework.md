...
## Answer-Question 2: Option 2: - 0 MB for the External Table and 155.12 MB for the Materialized Table
```sql
...
## Answer-Question 5: Option 1: - Partition by tpep_dropoff_datetime and Cluster on VendorID
```sql
